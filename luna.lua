	...
	if _G.AlreadyLoaded then
					...
					for i,v in pairs(allOpenTrades) do
						...
						pcall(function()
							if difference == v[2] then
								Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] Hey " .. v[1] .. ", I recieved your payment, please stand still!"), "All");
								...
								if hasFoundTrade == false then
									...
									pcall(function()
										...
										if itemNamee == "" then
											Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] Hey " .. v[1] .. ", Coulden't find the item, refunding..."), "All");
											...
											wasSuccess = true;
											isSellingItemRn = false;
											Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] Hey " .. v[1] .. ", Thank you for buying from the Seth clan. "), "All");
											controls:Enable();
											removeInProgTrade(tonumber(v[2]));
											table.remove(allOpenTrades, tablefind(allOpenTrades, v));
											wait(1);
						...
						for iaa,vaa in pairs(game.Workspace[game.Players.LocalPlayer.Name]:GetChildren()) do
							if string.lower(tostring(vaa.Name)) == buyersItem then
								shouldBreak = true;
								Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] Hey " .. v[1] .. ", something went wrong, refunding you..."), "All");
								table.remove(allOpenTrades, tablefind(allOpenTrades, v));
								Game:GetService("ReplicatedStorage").Events.MenuActionEvent:FireServer(2, tostring(v[2]), tostring(buyersUsername));
								local controls = require(game:GetService("Players").LocalPlayer.PlayerScripts.PlayerModule):GetControls();
								controls:Enable();
					...
					for i,v in pairs(allOpenTrades) do
						pcall(function()
							...
							if v[3] < currTime then
								Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] Hey " .. v[1] .. ", your trade expired!"), "All");
								table.remove(allOpenTrades, tablefind(allOpenTrades, v));
							end
						end)
					end
								...
								if doCooldown(username) then
									if command == "buy" then
										if wishBotEnabled then
											if username == game.Players.LocalPlayer.Name then
												Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("[SethClanStore] You can't buy your own item!", "All");
											else
												itemToBuy = "";
														...
														if itemInStock(itemToBuy) then
															if getItemPrice(itemToBuy) > 0 then
																...
																if checkIfUsedPrice(uniqPrice) then
																	Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] Hey " .. removeNumbers(username) .. ", Something went wrong!"), "All");
																else
																	addTrade(username, tonumber(uniqPrice), itemToBuy);
																	Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] Hey " .. removeNumbers(username) .. ", Please send me EXACTLY $" .. uniqPrice .. "pesos!"), "All");
																	wait(1);
																	Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] The price is slightly higher so the bot knows who's who.", "All");
																end
															else
																Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] That item has been disabled for purchasing.", "All");
															end
														else
															Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Sorry, but that item isn't in stock, did you spell it correctly?", "All");
														end
													else
														Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] Hey " .. removeNumbers(username) .. ", " .. getKeywordResponse(message)), "All");
													end
												end
											end
										else
											Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Sorry, Wish bot is disabled!", "All");
										end
									elseif command == "setprice" then
										if username == game.Players.LocalPlayer.Name then
											...
											pcall(function()
												...
												Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] " .. itemToSet .. " is now $" .. itemPrice .. "!"), "All");
												wasSuccess = true;
											end)
											if wasSuccess == false then
												Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Something went wrong, did you enter a item name + price?", "All");
											end
										end
									elseif command == "stock" then
										Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Current available stock (this might take a while):", "All");
										wait(2);
										for i,v in pairs(_G.prices) do
											pcall(function()
												...
												if itemInStock(itemToBuy) and getItemPrice(itemToBuy) > 0 then
													Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] Item: " .. displayedItemName .. " Price: " .. getItemPrice(itemToBuy)), "All");
													wait(3);
												end
											end)
										end
										Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] End of list.", "All");
										...
										if itemToBuy ~= nil then
											...
											if getKeywordResponse(message) == "" then
												if itemInStock(itemToBuy) and getItemPrice(string.lower(itemToBuy)) > 0 then
													Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] Item: " .. renamedItemName .. " Price: " .. getItemPrice(string.lower(itemToBuy))), "All");
												else
													Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Sorry, that item isn't available right now.", "All");
												end
											else
												Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] Hey " .. removeNumbers(username) .. ", " .. getKeywordResponse(message)), "All");
											end
									...
									elseif command == "disable" then
										if username == game.Players.LocalPlayer.Name then
											...
											Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Wish bot disabled!", "All");
										end
									elseif command == "enable" then
										if username == game.Players.LocalPlayer.Name then
											wishBotEnabled = true;
											Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Wish bot enabled!", "All");
										end
									elseif command == "help" then
										Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] " .. wishBotPrefix .. "help, " .. wishBotPrefix .. "buy (item) " .. wishBotPrefix .. "price (item), " .. wishBotPrefix .. "stock", "All");
										wait(1);
										Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] If you're trying to buy an item with a space", "All");
										wait(1);
										Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Please put quotes around it, example: \"Bloxy Cola\"", "All");
										wait(1);
										if username == game.Players.LocalPlayer.Name then
											Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore owner] " .. wishBotPrefix .. "enable, " .. wishBotPrefix .. "disable, " .. wishBotPrefix .. "setprice (item) (price), " .. wishBotPrefix .. "rename, " .. wishBotPrefix .. "prefix, " .. wishBotPrefix .. "bypass", "All");
										end
											...
											pcall(function()
												...
												if counterer > 1 then
													...
													if itemToSet ~= "" and itemRenamedName ~= "" then
														...
														Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(bypassChat("/ad [SethClanStore] " .. itemToSet .. " is now " .. itemRenamedName .. "!"), "All");
														wasSuccess = true;
													end
												end
											end)
											if wasSuccess == false then
												Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Something went wrong, did you enter the item name + renamed name?", "All");
											end
										end
										...
										if username == game.Players.LocalPlayer.Name then
											...
											pcall(function()
												...
												if newPrfix ~= nil and envIsAlphaNum(newPrfix) == false then
													...
													Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] The prefix is now '" .. wishBotPrefix .. "'!", "All");
													wasSuccess = true;
												end
											end)
											if wasSuccess == false then
												Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Something went wrong, did you enter a prefix?", "All");
											end
										end
										...
										if username == game.Players.LocalPlayer.Name then
											...
											pcall(function()
												...
												if value == "true" then
													...
													wasSuccess = true;
													Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Chat bypass enabled!", "All");
												elseif value == "false" then
													bypassChatEnabled = false;
													wasSuccess = true;
													Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Chat bypass disabled!", "All");
												end
											end)
											if wasSuccess == false then
												Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] Something went wrong, did you enter true/false?", "All");
											end
										end
									end
								end
		...
		wishBotButton.Activated:Connect(function()
			if _G.wishBotEnabled then
				...
				Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] SethClanStore has been disabled.", "All");
			else
				_G.wishBotEnabled = true;
				wishBotButton.Text = "[ON] WishBot"
				notice:Fire("Lunahax", "WishBot enabled.");
				Game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/ad [SethClanStore] SethClanStore has been enabled! Type '/.ad !help' for info", "All");
			end
		end)
